...
```bash
cd /Users/vickyfu/Documents/blockrun-web/IgniteRouter && bun run build 2>&1 | tail -5
```
...
```bash
cd /Users/vickyfu/Documents/blockrun-web/IgniteRouter && bun test src/error-classification.test.ts
```
...
```bash
cd /Users/vickyfu/Documents/blockrun-web/IgniteRouter && bun test 2>&1 | tail -20
```
...
```bash
cd /Users/vickyfu/Documents/blockrun-web/IgniteRouter && bun run build 2>&1
```
