...
When using `blockrun/auto`, IgniteRouter automatically classifies your request and picks the cheapest capable model:
...
- **GitHub Discussion:** [Share your setup](https://github.com/BlockRunAI/IgniteRouter/discussions)
- **Issues:** [Report problems](https://github.com/BlockRunAI/IgniteRouter/issues)
