...
This is exactly the problem [IgniteRouter](https://github.com/BlockRunAI/IgniteRouter) solves.
...
```bash
npx @blockrun/IgniteRouter    # Install and start (generates wallet automatically)
```
...
_IgniteRouter is built by [BlockRun](https://blockrun.ai). Source code: [github.com/BlockRunAI/IgniteRouter](https://github.com/BlockRunAI/IgniteRouter)_
